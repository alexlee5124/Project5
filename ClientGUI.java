...
public class ClientGUI extends JComponent implements Runnable {
    ...
    JComboBox<String> quizSelectionBox;
    ...
    ActionListener quizTakingListener = new ActionListener() {
        public void actionPerformed(ActionEvent e) {
            if (e.getSource() == submitButton) {
                ...
                String takenBefore = null;
                try {
                    takenBefore = reader.readLine();
                } catch (IOException ex) {
                    ex.printStackTrace();
                }
                if (takenBefore.equals("T")) {
                    JOptionPane.showMessageDialog(null, "You have already" +
                                    "taken this quiz before! Contact your teacher!"
                            , "Error", JOptionPane.ERROR_MESSAGE);
                } else if (takenBefore.equals("F")) {
    ...
    public void loadDeleteQuizPanel() {
        quizSelectionBox = new JComboBox<>();
